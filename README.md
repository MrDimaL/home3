# Warehouse Management System API + PostgreSQL

## Описание задания

В рамках лабораторной работы необходимо разработать и реализовать **PostgreSQL** для системы управления складом(WMS) с использованием C++ и фрейиворка userver.
